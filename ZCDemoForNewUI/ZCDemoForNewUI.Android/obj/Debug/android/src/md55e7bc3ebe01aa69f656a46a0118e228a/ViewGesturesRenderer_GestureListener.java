...
public class ViewGesturesRenderer_GestureListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ScnViewGestures.Plugin.Forms.Droid.Renderers.ViewGesturesRenderer+GestureListener, ScnViewGestures.Droid", ViewGesturesRenderer_GestureListener.class, __md_methods);
	}


	public ViewGesturesRenderer_GestureListener ()
	{
		super ();
		if (getClass () == ViewGesturesRenderer_GestureListener.class)
			mono.android.TypeManager.Activate ("ScnViewGestures.Plugin.Forms.Droid.Renderers.ViewGesturesRenderer+GestureListener, ScnViewGestures.Droid", "", this, new java.lang.Object[] {  });
	}
