...
{
    public partial class ListPageCommon 
    {
        public ListPageCommon(string Pagetitle) : base(PanelSetEnum.psLeftRight)
        {
            //InitializeComponent();
            #region right menu
            ...
            menuimage.HorizontalOptions = LayoutOptions.CenterAndExpand;
            ...
            List<LeftNavigationData> PreparedObject()
            {
                ...
                if (UserTypeID == 2)
                {
                    ...
                    navigationData.Section = "Dashboard";
                    navigationData.IsLogout = true;
                    //CultureUtility.GetResxNameByValue(Headers.REQUISITIONS);
